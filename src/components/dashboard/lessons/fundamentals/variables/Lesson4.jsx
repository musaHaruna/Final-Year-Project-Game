...
const Lesson4 = () => {
  ...
  const handlePlayLesson4 = (workspace, setOutput) => {
    ...
    if (errors.length > 0) {
      ...
      setOutput(
        `Please use "display A" and "display B" to display the variables`
      )
    }
  }
  ...
  return (
    <div>
      ...
      <p className='text-center'>
        <span className='font-bold'>Mission:</span> Store values and display
        them in programming and make the character start running
      </p>
      <Lesson
        elements={elements}
